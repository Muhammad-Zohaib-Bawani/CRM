...
import { validateInvitationToken, acceptInvitation } from '../services/auth.js';
...
export default function AcceptInvitation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ submit: err.message || 'Failed to set up account. The link may have expired.' });
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="login-form-wrap">
        ...
        {tokenState === 'invalid' && (
          <div className="login-form" style={{ textAlign: 'center' }}>
            ...
            <p className="lead" style={{ marginBottom: 24 }}>
              This invitation link is no longer valid. Please contact your administrator to resend the invitation.
            </p>
        ...
        {tokenState === 'valid' && !done && (
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            <p className="lead">Choose a password to activate your account.</p>
            ...
            >
              {loading
                ? <><i className="fa-solid fa-circle-notch fa-spin" /> Activating…</>
                : <><i className="fa-solid fa-lock" /> Activate Account</>}
            </button>
          </form>
        )}
      </div>
